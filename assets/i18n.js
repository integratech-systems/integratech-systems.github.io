...
(function () {
  ...
  var I18N = {
    en: {
      ...
      'manifesto.eyebrow':   'The engineer\'s advantage',
      'manifesto.h2':        'Technology made the individual engineer extraordinary.',
      'manifesto.lead':      'A senior engineer today commands tools that once required entire departments. Cloud-native infrastructure, AI-augmented development, and a decade of production battle scars compress what used to take a team of ten into what one focused engineer can own end-to-end.',
      'manifesto.quote':     'We didn\'t grow a team — we grew with the tools.',
      'manifesto.stat1.num': '1',
      'manifesto.stat1.label': 'engineer',
      'manifesto.stat1.sub': 'what once needed 6+',
      'manifesto.stat2.num': '220+',
      'manifesto.stat2.label': 'days uptime',
      'manifesto.stat2.sub': 'no SRE team required',
      'manifesto.stat3.num': '50k+',
      'manifesto.stat3.label': 'msg / sec',
      'manifesto.stat3.sub': 'single NiFi pipeline',
      'manifesto.stat4.num': '5',
      'manifesto.stat4.label': 'microservices',
      'manifesto.stat4.sub': 'owned by one person',
      ...
      'offer.eyebrow': 'Paid offer packages',
      'offer.h2': 'Choose a business outcome, not just a technology.',
      'offer.lead': 'Each package is designed as a clear entry point: fast audit, visible demo, production roadmap and a direct path to implementation.',
      'offer.ai.badge': 'AI integration',
      'offer.ai.title': 'LLM systems & intelligent agents',
      'offer.ai.body': 'RAG, tool-calling, multimodal assistants, Telegram/web bots and AI workflows that reach production instead of staying as demos.',
      'offer.ai.price': 'Starter audit from €1 500 · build from €6 000',
      'offer.security.badge': 'Zero-Trust',
      'offer.security.title': 'OpenBao / Vault security sprint',
      'offer.security.body': 'Move secrets out of code, add AppRole flows, rotate credentials and hide internal services behind a private mesh.',
      'offer.security.price': 'Setup sprint from €3 500',
      'offer.web3.badge': 'Web3',
      'offer.web3.title': 'Blockchain & dApp integrations',
      'offer.web3.body': 'Wallet auth, smart-contract integrations, token payments, blockchain event ingestion and Web3 UX for existing products.',
      'offer.web3.price': 'Prototype from €4 000',
      'offer.legacy.badge': 'Modernization',
      'offer.legacy.title': 'Legacy audit & refactoring plan',
      'offer.legacy.body': 'Map the legacy system, identify risky dependencies, design a migration path and extract the first safe service boundary.',
      'offer.legacy.price': '5-day audit from €2 500',
      'offer.media.badge': 'AI media',
      'offer.media.title': 'AI content production pack',
      'offer.media.body': 'Generate campaign visuals, short videos, prompts and publication assets with the Maya/Muse creative pipeline.',
      'offer.media.price': 'Creative pack from €500',
      'offer.crypto.badge': 'Fintech proof',
      'offer.crypto.title': 'FluidTrader analytics demo',
      'offer.crypto.body': 'Reactive trading dashboards, AI market brief and exchange integration proof for fintech teams and investors.',
      'offer.crypto.price': 'Demo access by request',
      'offer.cta': 'Start a project →',
    ...
    /* ═══════════════════════════════════════════════════════════ */
      ...
      /* ── index.html — Manifesto ── */
      'manifesto.eyebrow':   'Преимущество инженера',
      'manifesto.h2':        'Технологии сделали инженера экстраординарным.',
      'manifesto.lead':      'Сегодня один Senior-инженер владеет инструментами, для которых раньше требовались целые отделы. Cloud-native инфраструктура, AI-ускоренная разработка и десятилетие production-шрамов сжимают то, что раньше делала команда из десяти, — в то, что один сфокусированный инженер контролирует от начала до конца.',
      'manifesto.quote':     'Мы не масштабировали команду — мы масштабировались вместе с инструментами.',
      'manifesto.stat1.num': '1',
      'manifesto.stat1.label': 'инженер',
      'manifesto.stat1.sub': 'вместо команды из 6+',
      'manifesto.stat2.num': '220+',
      'manifesto.stat2.label': 'дней аптайма',
      'manifesto.stat2.sub': 'без SRE-команды',
      'manifesto.stat3.num': '50k+',
      'manifesto.stat3.label': 'сообщ. / сек',
      'manifesto.stat3.sub': 'один NiFi пайплайн',
      'manifesto.stat4.num': '5',
      'manifesto.stat4.label': 'микросервисов',
      'manifesto.stat4.sub': 'один владелец',
      ...
      'offer.eyebrow': 'Платные продуктовые пакеты',
      'offer.h2': 'Выбирайте бизнес-результат, а не просто технологию.',
      'offer.lead': 'Каждый пакет — понятная точка входа: быстрый аудит, видимое демо, production-roadmap и прямой путь к внедрению.',
      'offer.ai.badge': 'AI-интеграция',
      'offer.ai.title': 'LLM-системы и интеллектуальные агенты',
      'offer.ai.body': 'RAG, tool-calling, мультимодальные ассистенты, Telegram/web-боты и AI-процессы, которые доходят до production.',
      'offer.ai.price': 'Стартовый аудит от €1 500 · разработка от €6 000',
      'offer.security.badge': 'Zero-Trust',
      'offer.security.title': 'OpenBao / Vault security sprint',
      'offer.security.body': 'Убираем секреты из кода, добавляем AppRole, ротацию credentials и закрываем внутренние сервисы приватной mesh-сетью.',
      'offer.security.price': 'Setup sprint от €3 500',
      'offer.web3.badge': 'Web3',
      'offer.web3.title': 'Blockchain и dApp-интеграции',
      'offer.web3.body': 'Wallet auth, smart-contract интеграции, token payments, ingestion blockchain events и Web3 UX для существующих продуктов.',
      'offer.web3.price': 'Прототип от €4 000',
      'offer.legacy.badge': 'Модернизация',
      'offer.legacy.title': 'Аудит legacy и план рефакторинга',
      'offer.legacy.body': 'Картируем legacy-систему, находим рискованные зависимости, проектируем миграцию и выделяем первую безопасную границу сервиса.',
      'offer.legacy.price': '5-дневный аудит от €2 500',
      'offer.media.badge': 'AI media',
      'offer.media.title': 'Пакет AI-контент-продакшена',
      'offer.media.body': 'Генерация campaign visuals, коротких видео, промптов и публикационных материалов через pipeline Maya/Muse.',
      'offer.media.price': 'Creative pack от €500',
      'offer.crypto.badge': 'Fintech proof',
      'offer.crypto.title': 'FluidTrader analytics demo',
      'offer.crypto.body': 'Reactive trading dashboards, AI market brief и proof exchange-интеграций для fintech-команд и инвесторов.',
      'offer.crypto.price': 'Демо по запросу',
      'offer.cta': 'Запустить проект →',
    ...
    /* ═══════════════════════════════════════════════════════════ */
      ...
      /* ── index.html — Manifesto ── */
      'manifesto.eyebrow':   'Инженердің артықшылығы',
      'manifesto.h2':        'Технологиялар инженерді ерекше етті.',
      'manifesto.lead':      'Бүгінгі Senior-инженер бұрын бүкіл бөлімдерге қажет болған құралдарды меңгереді. Cloud-native инфрақұрылым, AI-жеделдетілген әзірлеу және он жылдық production тәжірибесі — бұрын он адамдық команда жасайтынды бір инженер бастан-аяқ басқара алады.',
      'manifesto.quote':     'Біз команданы өсірген жоқпыз — құралдармен бірге өстік.',
      'manifesto.stat1.num': '1',
      'manifesto.stat1.label': 'инженер',
      'manifesto.stat1.sub': '6+ адамның орнына',
      'manifesto.stat2.num': '220+',
      'manifesto.stat2.label': 'күн жұмыс',
      'manifesto.stat2.sub': 'SRE командасыз',
      'manifesto.stat3.num': '50k+',
      'manifesto.stat3.label': 'хабар / сек',
      'manifesto.stat3.sub': 'бір NiFi конвейер',
      'manifesto.stat4.num': '5',
      'manifesto.stat4.label': 'микросервис',
      'manifesto.stat4.sub': 'бір иесі',
      ...
      'offer.eyebrow': 'Ақылы пакеттер',
      'offer.h2': 'Тек технологияны емес, бизнес-нәтижені таңдаңыз.',
      'offer.lead': 'Әр пакет — нақты кіру нүктесі: жылдам аудит, көрінетін демо, production-roadmap және енгізуге тікелей жол.',
      'offer.ai.badge': 'AI интеграция',
      'offer.ai.title': 'LLM жүйелері және интеллектуалды агенттер',
      'offer.ai.body': 'RAG, tool-calling, мультимодалды ассистенттер, Telegram/web боттар және production-ға шығатын AI процестер.',
      'offer.ai.price': 'Бастапқы аудит €1 500 бастап · әзірлеу €6 000 бастап',
      'offer.security.badge': 'Zero-Trust',
      'offer.security.title': 'OpenBao / Vault security sprint',
      'offer.security.body': 'Құпияларды кодтан шығарамыз, AppRole, credentials ротациясын қосамыз және ішкі сервистерді private mesh арқылы жабамыз.',
      'offer.security.price': 'Setup sprint €3 500 бастап',
      'offer.web3.badge': 'Web3',
      'offer.web3.title': 'Blockchain және dApp интеграциялар',
      'offer.web3.body': 'Wallet auth, smart-contract интеграциялар, token payments, blockchain events ingestion және бар өнімдерге Web3 UX.',
      'offer.web3.price': 'Прототип €4 000 бастап',
      'offer.legacy.badge': 'Модернизация',
      'offer.legacy.title': 'Legacy аудиті және refactoring жоспары',
      'offer.legacy.body': 'Legacy жүйені картаға түсіреміз, тәуекелді тәуелділіктерді табамыз, миграцияны жобалаймыз және алғашқы қауіпсіз сервис шекарасын бөлеміз.',
      'offer.legacy.price': '5 күндік аудит €2 500 бастап',
      'offer.media.badge': 'AI media',
      'offer.media.title': 'AI контент production пакеті',
      'offer.media.body': 'Maya/Muse pipeline арқылы campaign visuals, қысқа video, prompt және жарияланым материалдарын жасаймыз.',
      'offer.media.price': 'Creative pack €500 бастап',
      'offer.crypto.badge': 'Fintech proof',
      'offer.crypto.title': 'FluidTrader analytics demo',
      'offer.crypto.body': 'Fintech командалар мен инвесторларға reactive trading dashboards, AI market brief және exchange integration proof.',
      'offer.crypto.price': 'Демо сұраныс бойынша',
      'offer.cta': 'Жобаны бастау →',
    ...
    /* ═══════════════════════════════════════════════════════════ */
      ...
      /* ── index.html — Manifesto ── */
      'manifesto.eyebrow':   'Der Vorteil des Ingenieurs',
      'manifesto.h2':        'Technologie hat den einzelnen Ingenieur außergewöhnlich gemacht.',
      'manifesto.lead':      'Ein Senior-Ingenieur heute beherrscht Werkzeuge, die früher ganze Abteilungen erforderten. Cloud-native Infrastruktur, KI-beschleunigte Entwicklung und ein Jahrzehnt Production-Erfahrung komprimieren, was früher ein Team von zehn benötigte.',
      'manifesto.quote':     'Wir haben kein Team aufgebaut — wir sind mit den Werkzeugen gewachsen.',
      'manifesto.stat1.num': '1',
      'manifesto.stat1.label': 'Ingenieur',
      'manifesto.stat1.sub': 'statt 6+ Personen',
      'manifesto.stat2.num': '220+',
      'manifesto.stat2.label': 'Tage Uptime',
      'manifesto.stat2.sub': 'ohne SRE-Team',
      'manifesto.stat3.num': '50k+',
      'manifesto.stat3.label': 'Nachr. / Sek.',
      'manifesto.stat3.sub': 'eine NiFi-Pipeline',
      'manifesto.stat4.num': '5',
      'manifesto.stat4.label': 'Microservices',
      'manifesto.stat4.sub': 'ein Verantwortlicher',
      ...
      'offer.eyebrow': 'Bezahlte Angebotspakete',
      'offer.h2': 'Wählen Sie ein Geschäftsergebnis, nicht nur eine Technologie.',
      'offer.lead': 'Jedes Paket ist ein klarer Einstieg: schneller Audit, sichtbare Demo, Production-Roadmap und direkter Weg zur Umsetzung.',
      'offer.ai.badge': 'AI-Integration',
      'offer.ai.title': 'LLM-Systeme und intelligente Agenten',
      'offer.ai.body': 'RAG, Tool-Calling, multimodale Assistenten, Telegram/Web-Bots und AI-Workflows, die in Produktion gehen.',
      'offer.ai.price': 'Starter-Audit ab €1.500 · Umsetzung ab €6.000',
      'offer.security.badge': 'Zero-Trust',
      'offer.security.title': 'OpenBao / Vault Security Sprint',
      'offer.security.body': 'Secrets aus dem Code entfernen, AppRole-Flows ergänzen, Credentials rotieren und interne Services per Private Mesh schützen.',
      'offer.security.price': 'Setup-Sprint ab €3.500',
      'offer.web3.badge': 'Web3',
      'offer.web3.title': 'Blockchain- und dApp-Integrationen',
      'offer.web3.body': 'Wallet Auth, Smart-Contract-Integrationen, Token Payments, Blockchain-Event-Ingestion und Web3 UX für bestehende Produkte.',
      'offer.web3.price': 'Prototyp ab €4.000',
      'offer.legacy.badge': 'Modernisierung',
      'offer.legacy.title': 'Legacy-Audit und Refactoring-Plan',
      'offer.legacy.body': 'Legacy-System kartieren, riskante Abhängigkeiten finden, Migration planen und die erste sichere Service-Grenze extrahieren.',
      'offer.legacy.price': '5-Tage-Audit ab €2.500',
      'offer.media.badge': 'AI Media',
      'offer.media.title': 'AI Content Production Pack',
      'offer.media.body': 'Kampagnenvisuals, Kurzvideos, Prompts und Publishing Assets mit der Maya/Muse Creative Pipeline erzeugen.',
      'offer.media.price': 'Creative Pack ab €500',
      'offer.crypto.badge': 'Fintech Proof',
      'offer.crypto.title': 'FluidTrader Analytics Demo',
      'offer.crypto.body': 'Reactive Trading Dashboards, AI Market Brief und Exchange-Integrationsnachweis für Fintech-Teams und Investoren.',
      'offer.crypto.price': 'Demo auf Anfrage',
      'offer.cta': 'Projekt starten →',
    ...
    /* ═══════════════════════════════════════════════════════════ */
      ...
      /* ── index.html — Manifesto ── */
      'manifesto.eyebrow':   "L'avantage de l'ingénieur",
      'manifesto.h2':        "La technologie a rendu l'ingénieur individuel extraordinaire.",
      'manifesto.lead':      "Un ingénieur senior aujourd'hui maîtrise des outils qui nécessitaient autrefois des départements entiers. L'infrastructure cloud-native, le développement augmenté par l'IA et une décennie de production condensent ce qui nécessitait une équipe de dix en ce qu'une personne concentrée peut contrôler de bout en bout.",
      'manifesto.quote':     "Nous n'avons pas fait grandir une équipe — nous avons grandi avec les outils.",
      'manifesto.stat1.num': '1',
      'manifesto.stat1.label': 'ingénieur',
      'manifesto.stat1.sub': 'là où 6+ étaient nécessaires',
      'manifesto.stat2.num': '220+',
      'manifesto.stat2.label': 'jours uptime',
      'manifesto.stat2.sub': 'sans équipe SRE',
      'manifesto.stat3.num': '50k+',
      'manifesto.stat3.label': 'msg / sec',
      'manifesto.stat3.sub': 'un seul pipeline NiFi',
      'manifesto.stat4.num': '5',
      'manifesto.stat4.label': 'microservices',
      'manifesto.stat4.sub': 'un seul propriétaire',
      ...
      'offer.eyebrow': 'Offres payantes',
      'offer.h2': 'Choisissez un résultat métier, pas seulement une technologie.',
      'offer.lead': "Chaque offre est un point d'entrée clair : audit rapide, démo visible, roadmap production et chemin direct vers l'implémentation.",
      'offer.ai.badge': 'Intégration AI',
      'offer.ai.title': 'Systèmes LLM et agents intelligents',
      'offer.ai.body': 'RAG, tool-calling, assistants multimodaux, bots Telegram/web et workflows AI qui arrivent en production.',
      'offer.ai.price': 'Audit starter à partir de €1 500 · build à partir de €6 000',
      'offer.security.badge': 'Zero-Trust',
      'offer.security.title': 'Sprint sécurité OpenBao / Vault',
      'offer.security.body': 'Sortir les secrets du code, ajouter les flux AppRole, faire tourner les credentials et protéger les services internes par private mesh.',
      'offer.security.price': 'Setup sprint à partir de €3 500',
      'offer.web3.badge': 'Web3',
      'offer.web3.title': 'Intégrations blockchain et dApp',
      'offer.web3.body': "Wallet auth, intégrations smart-contract, token payments, ingestion d'événements blockchain et UX Web3 pour produits existants.",
      'offer.web3.price': 'Prototype à partir de €4 000',
      'offer.legacy.badge': 'Modernisation',
      'offer.legacy.title': 'Audit legacy et plan de refactoring',
      'offer.legacy.body': 'Cartographier le legacy, identifier les dépendances risquées, concevoir la migration et extraire une première frontière de service sûre.',
      'offer.legacy.price': 'Audit 5 jours à partir de €2 500',
      'offer.media.badge': 'AI media',
      'offer.media.title': 'Pack production de contenu AI',
      'offer.media.body': 'Générer visuels de campagne, vidéos courtes, prompts et assets de publication avec le pipeline créatif Maya/Muse.',
      'offer.media.price': 'Creative pack à partir de €500',
      'offer.crypto.badge': 'Fintech proof',
      'offer.crypto.title': 'Démo analytics FluidTrader',
      'offer.crypto.body': 'Dashboards trading réactifs, AI market brief et preuve dintégration exchange pour équipes fintech et investisseurs.',
      'offer.crypto.price': 'Démo sur demande',
      'offer.cta': 'Lancer un projet →',
